...
import com.example.hdfp_11_2.scheduleAdapter.ScheduleAdapterSeven;

public class NonVegDaySeven extends AppCompatActivity {
    ...
    Spinner spinner;
    String foods []={"One cup of brown rice","Any vegetables","All fruits juices"};
    ArrayAdapter<String> arrayAdapter;
    ViewPager mviewPager;
    ScheduleAdapterSeven scheduleAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_non_veg_day_seven);

        spinner=(Spinner)findViewById(R.id.nonvegfood_snipper7);
        ...
        mviewPager=findViewById(R.id.scheduleflipper7);
        scheduleAdapter = new ScheduleAdapterSeven(getSupportFragmentManager());
    ...
    public void launchFoodsToAvoid(){
        Intent intent=new Intent(this, FoodsToAvoidDay07.class);
        startActivity(intent);
    }

    public void launchtip(){
        Intent intent=new Intent(this, Day07TipsToFollow.class);
        startActivity(intent);
    }
