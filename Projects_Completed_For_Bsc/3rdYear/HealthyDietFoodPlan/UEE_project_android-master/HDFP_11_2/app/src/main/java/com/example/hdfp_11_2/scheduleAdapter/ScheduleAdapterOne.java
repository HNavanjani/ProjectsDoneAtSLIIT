...
public class ScheduleAdapterOne extends FragmentPagerAdapter {

    public ScheduleAdapterOne(FragmentManager fm){
        super(fm);
    }
    @Override
    public Fragment getItem(int position) {
//        NonVegHomeDayOneFragment nonVegHomeFragment=new NonVegHomeDayOneFragment();
//        position=position+1; //position is start from 0
//        Bundle bundle = new Bundle();
//        //to pass some strings
//
//        bundle.putString("message","Fragment "+position);
//        //attach bundle objects to fragment
//        nonVegHomeFragment.setArguments(bundle);
//
//        return nonVegHomeFragment;
        if(position==0)
