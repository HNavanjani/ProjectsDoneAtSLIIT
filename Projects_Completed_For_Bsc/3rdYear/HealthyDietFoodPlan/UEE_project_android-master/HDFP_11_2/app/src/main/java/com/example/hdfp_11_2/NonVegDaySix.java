...
import com.example.hdfp_11_2.scheduleAdapter.ScheduleAdapterSix;

public class NonVegDaySix extends AppCompatActivity {
    ...
    Spinner spinner;
    String foods []={"One cup of brown rice","Cooked or uncooked vegetables","8 to 12 glass of water"};
    ArrayAdapter<String> arrayAdapter;
    ViewPager mviewPager;
    ScheduleAdapterSix scheduleAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_non_veg_day_six);

        spinner=(Spinner)findViewById(R.id.nonvegfood_snipper6);
        ...
        mviewPager=findViewById(R.id.scheduleflipper6);
        scheduleAdapter = new ScheduleAdapterSix(getSupportFragmentManager());
    ...
    public void launchFoodsToAvoid(){
        Intent intent=new Intent(this, FoodsToAvoidDay06.class);
        startActivity(intent);
    }

    public void launchtip(){
        Intent intent=new Intent(this, Day06TipsToFollow.class);
        startActivity(intent);
    }
