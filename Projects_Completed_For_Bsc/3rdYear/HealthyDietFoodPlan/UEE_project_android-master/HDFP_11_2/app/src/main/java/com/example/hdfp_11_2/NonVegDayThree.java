...
import com.example.hdfp_11_2.scheduleAdapter.ScheduleAdapterThree;

public class NonVegDayThree extends AppCompatActivity {
    ...
    Spinner spinner;
    String foods []={"Vegetables except Potato","Fruits excepts Banana","8 to 12 glass of water"};
    ArrayAdapter<String> arrayAdapter;
    ViewPager mviewPager;
    ScheduleAdapterThree scheduleAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_non_veg_day_three);
        spinner=(Spinner)findViewById(R.id.nonvegfood_snipper3);
        ...
        mviewPager=findViewById(R.id.scheduleflipper3);
        scheduleAdapter = new ScheduleAdapterThree(getSupportFragmentManager());
    ...
    public void launchFoodsToAvoid(){
        Intent intent=new Intent(this, FoodsToAvoidDay03.class);
        startActivity(intent);
    }

    public void launchtip(){
        Intent intent=new Intent(this, Day03TipsToFollow.class);
        startActivity(intent);
    }
