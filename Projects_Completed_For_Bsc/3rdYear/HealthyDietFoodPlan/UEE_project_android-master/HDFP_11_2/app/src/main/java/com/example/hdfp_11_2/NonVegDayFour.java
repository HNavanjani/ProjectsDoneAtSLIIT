...
import com.example.hdfp_11_2.scheduleAdapter.ScheduleAdapterFour;

public class NonVegDayFour extends AppCompatActivity {
    ...
    Spinner spinner;
    String foods []={"8 to 10 bananas","4 glass of milk","8 to 12 glass of water"};
    ArrayAdapter<String> arrayAdapter;
    ViewPager mviewPager;
    ScheduleAdapterFour scheduleAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_non_veg_day_four);

        spinner=(Spinner)findViewById(R.id.nonvegfood_snipper4);
        ...
        mviewPager=findViewById(R.id.scheduleflipper4);
        scheduleAdapter = new ScheduleAdapterFour(getSupportFragmentManager());
    ...
    public void launchFoodsToAvoid(){
        Intent intent=new Intent(this, FoodsToAvoidDay04.class);
        startActivity(intent);
    }

    public void launchtip(){
        Intent intent=new Intent(this, Day04TipsToFollow.class);
        startActivity(intent);
    }
