...
import com.example.hdfp_11_2.scheduleAdapter.ScheduleAdapterTwo;

public class NonVegDayTwo extends AppCompatActivity {
    ...
    Spinner spinner;
    String foods []={"Boiled Potato","Cooked or uncooked Vegetables","Carrots","Beans","Tomatoes","Cucumbers","Lettuce","Cabbage","8 to 12 glass of water"};
    ArrayAdapter<String> arrayAdapter;
    ViewPager mviewPager;
    ScheduleAdapterTwo scheduleAdapter;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_non_veg_day_two);

        spinner=(Spinner)findViewById(R.id.nonvegfood_snipper2);
        ...
        mviewPager=findViewById(R.id.scheduleflipper2);
        scheduleAdapter = new ScheduleAdapterTwo(getSupportFragmentManager());
    ...
    public void launchFoodsToAvoid(){
        Intent intent=new Intent(this, FoodsToAvoidDay02.class);
        startActivity(intent);
    }

    public void launchtip(){
        Intent intent=new Intent(this, Day02TipsToFollow.class);
        startActivity(intent);
    }
